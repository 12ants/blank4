...
<div id="content">
* * @link https://developer.wordpress.org/themes/basics/template-files/#template-partials * * @package blank4 */ ?>
<!DOCTYPE html>
...
?>
<h2 class="site-description"><?php echo $blank4_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></h2>
<?php endif; ?>
</div>
...
<?php esc_html_e( 'Primary Menu', 'blank4' ); ?>
<h4 id="burger">#</h4>
